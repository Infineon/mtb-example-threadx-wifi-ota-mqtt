...
void ota_task(cy_thread_arg_t arg)
{
...
void init_ota()
{
    ...
    mqtt_credentials.root_ca = ROOT_CA_CERTIFICATE;
    mqtt_credentials.root_ca_size = sizeof(ROOT_CA_CERTIFICATE);
    mqtt_credentials.client_cert = CLIENT_CERTIFICATE;
    mqtt_credentials.client_cert_size = sizeof(CLIENT_CERTIFICATE);
    mqtt_credentials.private_key = CLIENT_KEY;
    mqtt_credentials.private_key_size = sizeof(CLIENT_KEY);

    memcpy(&(ota_network_params.mqtt.credentials), &mqtt_credentials, sizeof(cy_awsport_ssl_credentials_t));
}
